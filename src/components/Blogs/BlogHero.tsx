...
const BlogHero = () => {
  return (
    <section className="blogHero-section">
      ...
      <div className="blogHero-content">
        <h1 className="blogHero-title">
          Stories that inspire your <br className="hidden-mobile" />
          <span className="blogHero-highlight">next journey.</span>
        </h1>
        <p className="blogHero-subtitle">
          Dive into real experiences, hidden gems, and expert guides from the SyncTrip community.
        </p>
      </div>
    </section>
  );
